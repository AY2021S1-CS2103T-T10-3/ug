...
\subsubsection{Undoing Commands — \texttt{\bld{undo}} (Alex)}
...
\subsubsection{Redoing Commands — \texttt{\bld{redo}} (Alex)}
...
\subsubsection{Listing Recommendations — \texttt{\bld{list} recommendations} (Alex)}
