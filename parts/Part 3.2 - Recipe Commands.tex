...
\subsubsection{Adding Recipes — \texttt{\bld{add} recipe}}
...
\subsubsection{Finding Recipes — \texttt{\bld{find} recipe}}
...
\subsubsection{Filtering Recipes — \texttt{\bld{filter} recipe}}
